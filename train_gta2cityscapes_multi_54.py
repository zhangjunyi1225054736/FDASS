...
DATA_LIST_PATH_TARGET = './dataset/cityscapes_list/train_54.txt'
...
def set_cuda(model, model_D1, model_D2):
    model = model.cuda(3)
    model_D1 = model_D1.cuda(2)
    model_D2 = model_D2.cuda(2)
...
def main():
    ...
    if args.model == 'DeepLab':
        ...
        if args.restore_from[:4] == 'http' :
            ...
            saved_state_dict = torch.load('snapshots/GTA2Cityscapes_multi_54/GTA5_10000.pth')
