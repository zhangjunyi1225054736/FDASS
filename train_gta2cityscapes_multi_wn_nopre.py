...
ITER_SIZE = 1
NUM_WORKERS = 4
DATA_DIRECTORY = '/home/zhangjunyi/AdaptSegNet/data/cyclegta5'
DATA_LIST_PATH = 'dataset/gta5_list/train.txt'
IGNORE_LABEL = 255
# INPUT_SIZE = '1280,720'
INPUT_SIZE = '1024,512'
DATA_DIRECTORY_TARGET = '/home/zhangjunyi/AdaptSegNet/data/cityscapes'
DATA_LIST_PATH_TARGET = './dataset/cityscapes_list/train_90.txt'
...
def loss_calc(pred, label, gpu, alpha=0):
    ...
    if alpha != 0:
        ...
        soft_pred, pre_ids = torch.max(F.softmax(tem_pred, 1), 1)
...
def main():
    ...
    if args.model == 'DeepLab':
        ...
        if args.restore_from[:4] == 'http' :
            ...
            saved_state_dict = torch.load('/home/zhangjunyi/hjy_code/resnet101-pretrained.pth')
